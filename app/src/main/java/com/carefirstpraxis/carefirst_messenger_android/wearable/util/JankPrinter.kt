package com.carefirstpraxis.carefirst_messenger_android.wearable.util
...
import com.carefirstpraxis.carefirst_messenger_android.wearable.BuildConfig
...
class JankPrinter {
  ...
  fun installJankStats(activity: Activity) {
    ...
    if (!BuildConfig.DEBUG) {
      ...
      jankStats = JankStats.createAndTrack(activity.window) {
        if (it.isJank) {
